...
// Source: backend-master-class/db/sqlc (interfaces: Store)
...
func (m *MockStore) ListCurrencies(arg0 context.Context) ([]db.Currency, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListCurrencies(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListCurrencies", reflect.TypeOf((*MockStore)(nil).ListCurrencies), arg0)
}

// ListEntries mocks base method.
func (m *MockStore) ListEntries(arg0 context.Context, arg1 int32) ([]db.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 int32) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
